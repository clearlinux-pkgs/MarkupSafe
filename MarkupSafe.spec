...
Source0  : https://files.pythonhosted.org/packages/fb/5a/fb1326fe32913e663c8e2d6bdf7cde6f472e51f9c21f0768d9b9080fe7c5/MarkupSafe-2.1.4.tar.gz
...
%prep
%setup -q -n MarkupSafe-2.1.4
cd %{_builddir}/MarkupSafe-2.1.4
pushd ..
cp -a MarkupSafe-2.1.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705862782
